...
public class Fragment_Schedule_Day2 extends Fragment
{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        Log.d("arrayList_visibility","arrayList_visibility"+arrayList_visibility.size());
        Log.d("arrayList_sc_date","arrayList_sc_date"+Tabs_Schedule.arrayList_sc_date.size());
        for (int i = 0 ; i < Tabs_Schedule.arrayList_sc_id.size() ; i++)
        {
            if (Tabs_Schedule.arrayList_date.get(1).equals(Tabs_Schedule.arrayList_date_compare.get(i)))
            {
