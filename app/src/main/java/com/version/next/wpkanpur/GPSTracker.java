			...
			if (!isGPSEnabled && !isNetworkEnabled) {
				...
				if (isGPSEnabled) {
					if (location == null) {
						...
						Log.d("locationManager", "locationManager->" + locationManager);
						...
						if (locationManager != null) {
							...
							Log.d("locationManager", "locationManager->" + location.getLatitude());
							Log.d("locationManager", "locationManager->" + location.getLongitude());
