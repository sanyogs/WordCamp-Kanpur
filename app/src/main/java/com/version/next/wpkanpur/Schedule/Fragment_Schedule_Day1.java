...
public class Fragment_Schedule_Day1 extends Fragment
{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
    {
        ...
        {
            if (Tabs_Schedule.arrayList_date.get(0).equals(Tabs_Schedule.arrayList_date_compare.get(i)))
            {
                Log.d("arrayList_sc_id-->","arrayList_sc_id"+Tabs_Schedule.arrayList_sc_id.get(i));
                Log.d("arrayList_sc_title","arrayList_sc_title"+Tabs_Schedule.arrayList_sc_title.get(i));
                Log.d("arrayList_sc_date","arrayList_sc_date"+Tabs_Schedule.arrayList_sc_date.get(i));
                Log.d("arrayList_sc_speaker","arrayList_sc_speaker"+Tabs_Schedule.arrayList_sc_speaker.get(i));
                Log.d("arrayList_sc_content","arrayList_sc_content"+Tabs_Schedule.arrayList_sc_content.get(i));
                Log.d("arrayList_visibility","arrayList_visibility"+arrayList_visibility.get(i));
                Log.d("arrayList_sc_speakerid","arrayList_sc_speakerid"+Tabs_Schedule.arrayList_sc_speakerid.get(i));
