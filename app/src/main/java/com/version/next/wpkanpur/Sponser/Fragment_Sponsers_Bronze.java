...
public class Fragment_Sponsers_Bronze extends Fragment
{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        {
            if (Tabs_Sponser.arrayList_sponsor_type.get(i).equalsIgnoreCase("Bronze"))
            {
                arrayList_all_sponsor.add(new All_Sponser(Tabs_Sponser.arrayList_sponsor_id.get(i),
                        ...
                        Tabs_Sponser.arrayList_sponsor_title.get(i),"Bronze",""
